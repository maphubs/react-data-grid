	...
	var Row = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var divProps = Object.keys(this.props).reduce(function (props, key) {
	      if (['columns', 'row', 'cellRenderer', 'cellMetaData', 'isSelected', 'idx', 'expandedRows', 'extraClasses', 'forceUpdate'].indexOf(key) >= 0) {
	        return props;
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cell = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var divProps = Object.keys(this.props).reduce(function (props, key) {
	      if (['rowIdx', 'idx', 'selected', 'selectedColumn', 'ref', 'column', 'isExpanded', 'isRowSelected', 'cellMetaData', 'handleDragStart', 'cellControls', 'rowData', 'forceUpdate'].indexOf(key) >= 0) {
	        return props;
	      }
	    ...
	    return React.createElement(
	      'div',
	      _extends({}, divProps, { className: className, style: style, onContextMenu: this.onCellContextMenu }, events),
	      cellContent,
	      dragHandle
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeaderRow = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var divProps = Object.keys(this.props).reduce(function (props, key) {
	      if (['columns', 'onColumnResize', 'onSort', 'onColumnResizeEnd', 'sortColumn', 'sortDirection', 'cellRenderer', 'headerCellRenderer', 'filterable', 'onFilterChange', 'resizing', 'onScroll', 'rowType'].indexOf(key) >= 0) {
	        return props;
	      }
	      props[key] = _this2.props[key];
	      return props;
